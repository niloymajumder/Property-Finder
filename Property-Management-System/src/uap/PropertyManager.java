...
public class PropertyManager {
    ...
    public String addUser(String name, int age, boolean
    		isAdmin) {
    ...
    public String addProperty(String location, double
    		rent, double floorSpace, int noOfBedRoom, int
    		noOfWashRoom, boolean hasGenerator) {
    ...
    public String addProperty(String location, double
    		rent, double floorSpace, boolean hasFireExit) {
